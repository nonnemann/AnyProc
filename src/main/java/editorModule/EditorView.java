...
import dragAndDropHandling.DropGestureHandler;
import editorModule.Edge;
import editorModule.Editor;
import main.App;
import main.FrameHandler;
import main.RightClickPopUpListener;
import transferHandling.DataTransferHandler;
import transferHandling.FileLoader;
import transferHandling.FileSaver;
...
public class EditorView extends JFrame{
    ...
    public EditorView(Editor editor) {
        ...
        super("Analytical Toolchain editorModule.Editor");
        ...
        // Add main.RightClickPopUpListener Listener
    ...
    private void setupMenuBar()
    {
        ...
        newToolchainItem.addActionListener(e -> App.globalGraph.resetGraph());
