...
{
	public static ExchangeProcess createExchangeProcess(ExchangeProcessView view, SourceInSlot originTool, SourceInSlot destinationTool)
	{
	...
	private static ExchangeProcess createDefaultExchangeProcess(SourceInSlot originTool, SourceInSlot destinationTool, Action action)
	{
	...
	private static ExchangeProcess createCustomExchangeProcess(ExchangeProcessView view, SourceInSlot originTool, SourceInSlot destinationTool, Action action)
	{
		ExchangeProcess exchangeProcess = new ExchangeProcess();
	...
	private static Action generateAction(SourceInSlot originTool, String action)
	{
