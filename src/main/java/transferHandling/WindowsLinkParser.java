 ...
 */
public class WindowsLinkParser {
     ...
     */
    public boolean isPotentialValidLink(final File file) throws IOException {
    ...
    public WindowsLinkParser(final File file) throws IOException, ParseException {
